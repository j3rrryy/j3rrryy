...
![Java](https://skillicons.dev/icons?i=java,spring&perline=10)

![Python](https://skillicons.dev/icons?i=python,fastapi,django,flask&perline=10)

![Other](https://skillicons.dev/icons?i=postgres,redis,mongodb,nginx,kafka,prometheus,grafana,docker,kubernetes&perline=15)
